...
# On copie d'abord uniquement le manifest pour profiter du cache Docker :
# tant que go.mod ne change pas, ce layer n'est pas rejoué.
# Pas de go.sum pour l'instant : le module n'a aucune dépendance externe.
COPY go.mod ./
RUN go mod download
